      ...
      >
        ...
        <div>
          ...
          <div className="p-4 flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4">
            <div id="text-box" className="order-1 md:order-0 md:w-2/4 max-w-xl">
              ...
              <div className="">
                ...
                <p className="pt-2 md:pt-2">
                  ...
                  learned valuable skills and gained real-world experience
                  across multiple teams, including a team that worked on Dell's
                  largest sales application. For more information, please see my
                  resume.
                </p>
                <p className="pt-2 md:pt-2">
                  I am currently open to technical job opportunities to take my
                  career to the next level. I created this website to
