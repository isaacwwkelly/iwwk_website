    ...
    <div id="career-container" className="bg-transparent">
      ...
      >
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "https://drive.google.com/file/d/1Hg5eU-fZuJNGryw3FsDlIICcQbx4CtJQ/view?usp=sharing",
              "_blank"
            )
          }
        >
        ...
        <CareerCard
          ...
          bulletpoints={[
            "Front End developer for Ascend OS - Apex’s cloud-native ecosystem with over $270B AUM, purpose-built for fintechs, broker-dealers, and wealth management firms. Introduced many Claude Code skills to the UI Engineering org that streamlined the ticket to PR process, increasing throughput by 60%",
