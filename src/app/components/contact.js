        ...
        <div className="w-full max-w-2xl flex flex-col gap-8 items-center">
          <div className="w-full p-4 border-2 border-[var(--border-color)] shadow-md rounded-2xl">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full max-w-xs self-center py-4 font-semibold bg-[var(--button-c)] hover:bg-[var(--button-c-hov)] focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 rounded-lg cursor-pointer"
              >
                {isSubmitting ? (
                  <svg
